...
-- Insert domains
INSERT INTO domain (id, 'name', creator_id, description, parent_id, owner_id) VALUES (0, 'root', 0, 'Root node of the domain tree', 0, 0);
INSERT INTO domain (id, 'name', creator_id, description, parent_id, owner_id) VALUES (1, 'winston', 1, 'Root node of the winston application domain branch', 0, 1);
INSERT INTO domain (id, 'name', creator_id, description, parent_id, owner_id) VALUES (2, 'service', 1, 'Domain of the winston service application', 1, 1);
INSERT INTO domain (id, 'name', creator_id, description, parent_id, owner_id) VALUES (3, 'web', 1, 'Domain of the winston client web application', 1, 1);
-- END domain
